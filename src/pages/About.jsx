...
export const About = () => {
  ...
  return (
    <>
      ...
      <motion.div
        dir="rtl"
        className="mx-auto w-[90%] px-4 py-16 mt-[60px] space-y-20"
      ...
      >
        ...
        >
          ...
          >
شركة سعودية استثمارية عائلية تأسست عام 2002م من قِبل ماجد بن ناصر العمري، مالك ورئيس المجموعة. وتُعد امتدادًا لاستثمارات "الشيخ ناصر العمري وإخوانه – رحمهم الله"، أحد رواد الاستثمار والعمل الاجتماعي والثقافي على مستوى المملكة، ومدينة بريدة خصوصًا.
تستثمر المجموعة في عدد من الشركات السعودية المحلية، وتعمل في التطوير العقاري من خلال مشاريعها التجارية والإسكانية، وتركّز استثماراتها على مدينة بريدة. كما تتكامل في تقديم خدماتها ومشاريعها من خلال الشراكة مع عدد من كبرى الشركات المتخصصة.
وتنشط في خدمة المجتمع عبر "العمري لخدمة المجتمع"، وهي مؤسسة مبادرات اجتماعية تابعة للمجموعة، تتبنى العديد من المبادرات الهادفة إلى تنمية المجتمع ومدينة بريدة.
          </motion.p>
          <motion.p
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl leading-relaxed"
          >
أن نكون مجموعة عقارية استثمارية متميزة على مستوى المملكة، ذات استثمارات متعددة، وأن نتميز بقدرتنا على القيادة والمشاركة في تأسيس مشاريع وشركات بمنهجية علمية مدروسة، ونمتلك وندير حصصًا واستثمارات استراتيجية في كبرى الشركات المساهمة.
          </motion.p>
        </motion.section>
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl leading-relaxed"
          >
تعمل مجموعتنا على تطوير المشاريع العقارية والاستثمارية بأعلى المعايير العالمية، وتقديم أفضل خدمات البيع والتأجير، وتسويق الأفكار التنموية المتميزة في جميع القطاعات الاقتصادية، وتحويل المعارف والخبرات المتراكمة إلى مشاريع ذات أبعاد تنموية وعوائد مالية مجزية.
وذلك استنادًا إلى الريادة الاقتصادية لاستثمارات ومشاريع الشيخ ناصر بن سليمان العمري – رحمه الله – وأسرة العمري التجارية، من خلال عطائها للاقتصاد الوطني، وتعزيزها بالمعارف والخبرات الحديثة والمتنوعة التي تمتلكها المجموعة ومؤسساتها وشركاتها التابعة والشقيقة.
          </motion.p>
        </motion.section>
        ...
        >
          ...
          >
            ...
            <div className="md:flex-1 space-y-4 text-xl sm:text-2xl leading-relaxed">
              <p>
              يرأس ماجد بن ناصر العمري
ويمثل امتدادًا لاستثمارات ومشاريع والده الشيخ ناصر بن سليمان العمري وأعمامه – رحمهم الله – الذين كانت لهم أدوار رئيسية في تأسيس عدد من المشاريع الاقتصادية والتنموية، ومنها دورهم الرئيس في تأسيس شركة أسمنت القصيم، وصحيفة القصيم، ومطابع القصيم، ودورهم في تأسيس التعليم النظامي بالقصيم، إضافة إلى مشاريع عقارية وزراعية رائدة.
              </p>
              <p>
              وقد حققت مجموعة ماجد العمري منذ تأسيسها مشاريع عقارية كبرى تجارية وسكنية، وأسهمت في تحقيق نقلة استثمارية في محفظة المجموعة التي يرأسها ماجد بن ناصر العمري، والذي كانت له أدوار اقتصادية واجتماعية مهمة، من خلال عضويته في عدد من الشركات والمؤسسات، ومنها:
              </p>
              <div>
        ...
        >
          <div className="flex items-center mb-6">
            <motion.h2
              variants={textVariant(0.5)}
              className="relative inline-block text-[#ab8e3a] text-[28px] sm:text-4xl md:text-5xl font-semibold ml-4 "
            >
